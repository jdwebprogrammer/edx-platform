...
from cms.djangoapps.contentstore.xblock_storage.view_handlers import VisibilityState
...
class TestSubsectionGating(CourseTestCase):
    ...
    @patch('cms.djangoapps.contentstore.xblock_storage.view_handlers.gating_api.add_prerequisite')
    ...
    @patch('cms.djangoapps.contentstore.xblock_storage.view_handlers.gating_api.remove_prerequisite')
    ...
    @patch('cms.djangoapps.contentstore.xblock_storage.view_handlers.gating_api.set_required_content')
    ...
    @patch('cms.djangoapps.contentstore.xblock_storage.view_handlers.gating_api.get_prerequisites')
    @patch('cms.djangoapps.contentstore.xblock_storage.view_handlers.gating_api.get_required_content')
    @patch('cms.djangoapps.contentstore.xblock_storage.view_handlers.gating_api.is_prerequisite')
    @ddt.data(
        (90, None),
        (None, 90),
        (100, 100),
